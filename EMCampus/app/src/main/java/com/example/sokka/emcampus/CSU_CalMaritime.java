...
public class CSU_CalMaritime extends AppCompatActivity implements InfoTemplate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__cal_maritime); //change this one to the respective XML Layout
